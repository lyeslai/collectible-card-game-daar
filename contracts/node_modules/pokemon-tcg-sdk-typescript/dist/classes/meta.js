...
var Meta = /** @class */ (function () {
     ...
     */
    Meta.allTypes = function () {
        return __awaiter(this, void 0, void 0, function () {
            var resposne;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client_1.Client.get('types')];
                    case 1:
                        resposne = _a.sent();
     ...
     */
    Meta.allSubtypes = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client_1.Client.get('subtypes')];
                    case 1:
                        response = _a.sent();
     ...
     */
    Meta.allSupertypes = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client_1.Client.get('supertypes')];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response];
                }
     ...
     */
    Meta.allRarities = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, client_1.Client.get('rarities')];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response];
                }

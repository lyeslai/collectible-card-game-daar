...
var Client = /** @class */ (function () {
    function Client() {
        ...
        this.POKEMONTCG_API_KEY = process.env.POKEMONTCG_API_KEY;
    }
    ...
    Client.prototype.get = function (resource, params) {
        return __awaiter(this, void 0, void 0, function () {
            var url, headers, config;
            return __generator(this, function (_a) {
                url = this.POKEMONTCG_API_URL + "/" + resource;
                headers = {
    ...
    Client.prototype.stringify = function (params) {

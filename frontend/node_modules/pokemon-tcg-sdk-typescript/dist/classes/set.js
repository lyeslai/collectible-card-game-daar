...
var Set = /** @class */ (function () {
    ...
    Set.prototype.resource = function () {
        return 'sets';
    };
    /**
     ...
     */
    Set.find = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, queryBuilder_1.QueryBuilder.find(this, id)
    ...
    Set.all = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, queryBuilder_1.QueryBuilder.all(this)
                        .then(function (response) {
                        return response;
                    })
                        .catch(function (error) { return Promise.reject(error); })];
     ...
     */
    Set.where = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, queryBuilder_1.QueryBuilder.where(this, params)
                        .then(function (response) {
                        return response;
                    })
                        .catch(function (error) { return Promise.reject(error); })];
